For my final, I produced a series of generative works. My plan at the start of the project was to
develop simple algorithms built around vectors and grids, then let them evolve functionally or
aesthetically across each iteration. My inspiration comes from Casey Reas’ *Process* series,
John Conway’s *Game of Life*, and early generative artists such as Georg Nees and Frieder
